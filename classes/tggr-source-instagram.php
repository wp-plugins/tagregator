			...
			if ( isset( $term->term_id ) ) {
				...
				if ( isset( $latest_post[0]->ID ) ) {
					...
					if ( $source_id ) {
						...
						$settings[ __CLASS__ ]['_newest_media_id'] = $source_id;	// todo doesn't this need to be stored for each hashtag? only matters when multiple tags setup on same site, though
